"!http://api.flattr.com/button/flattr-badge-large.png!":https://flattr.com/submit/auto?user_id=kstenschke&url=https://github.com/kstenschke/referencer-plugin/&title=referencer-plugin&language=java&tags=github,plugin,referencer&category=software
