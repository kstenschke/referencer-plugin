...
* Ctrl+Shift+Alt+C twice - Open list of references for inserting into the current document
* Ctrl+Shift+Alt+V twice - Open list of references for copying to clipboard
